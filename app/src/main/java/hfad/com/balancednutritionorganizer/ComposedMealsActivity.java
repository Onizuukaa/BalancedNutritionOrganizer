    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_addMealsToDailyMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(ComposedMealsActivity.this, "Please select 5 meals", Toast.LENGTH_SHORT).show();
                }else {
...
//                        weight_Sum += parseDouble(selectedMeals.get(i).getProductWeight());
                    ...
                    Toast.makeText(ComposedMealsActivity.this, "Addded to database", Toast.LENGTH_SHORT).show();
